...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed  z-[55]  inset-0  bg-black/5 backdrop-blur-[5px] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 ",
  ...
  (
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          dialogVariants({ size }),
          "max-h-[90vh] overflow-y-auto", // Added this to enable scrolling
          className
        )}
        {...props}
      >
