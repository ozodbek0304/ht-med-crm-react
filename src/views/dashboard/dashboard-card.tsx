    ...
    return (
        data.map((item: any, index: number) => (
            ...
            >
                ...
                ></span>
                <div className={`w-12 h-12 grid place-content-center rounded-full border border-dashed border-${item.color} dark:border-primary-foreground/60`}>
                    <span className={cn(`h-10 w-10 rounded-full grid place-content-center  bg-${item.color}`, {
